...
header('Access-Control-Allow-Methods: GET, POST, PUT, DELETE, OPTIONS'); // Allow all CRUD methods
header('Access-Control-Allow-Headers: Content-Type, Authorization'); // Essential for JWT
